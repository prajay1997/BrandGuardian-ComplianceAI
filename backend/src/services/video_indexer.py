...
class VideoIndexerService:
    def __init__(self):
        ...
        self.vi_name = os.getenv("AZURE_VI_NAME", "brand-yt-project-prajay")
    ...
    def download_youtube_video(self, url, output_path="temp_video.mp4"):
        ...
        ydl_opts = {
         'format': 'best', # the quality of the video to download
         'outtmpl': output_path, # output template
         'quiet': False,  ## Shows the logs while downloading
         'no_warnings': False, # show warnings while downloading if it occurs
    # Add these options:
        # Tell yt_dlp to behave like the Android app or a normal web browser.
        # This helps avoid download issues when YouTube blocks certain clients.
         'extractor_args': {'youtube': {'player_client': ['android', 'web']}},
        # Send a browser User-Agent so YouTube treats this request like it came
        # from a real Chrome browser instead of a Python script.
         'http_headers': {
        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36' # Mozilla/5.0 ..."This request is coming from a normal web browser."
                                                                                     # Many modern browsers (Chrome, Edge, Firefox, Safari) still start their User-Agent with:
    }
